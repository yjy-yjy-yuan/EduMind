...
os.environ["QIANFAN_AK"] = "ALTAKZjMQd3MxOTmZNApyoop89"  # 替换为你的 AK
os.environ["QIANFAN_SK"] = "9e9c6d0c89e14f2baf699e96b4bfbcf5"  # 替换为你的 SK

# 使用 AK/SK 进行认证，直接初始化 ChatCompletion
# 请注意，`qianfan` SDK 可能会自动处理 `access_token`，但在这种情况下，我们显式使用 AK/SK
