# EduMind 智能教育视频分析系统 - 可执行文档

本文档详细说明了EduMind系统的功能模块及其执行方法，帮助用户快速上手并使用系统的各项功能。

## 系统概述

EduMind是一个智能教育视频分析系统，旨在通过AI技术提升教育视频的学习效果。系统能够自动处理教育视频，提取关键知识点，构建知识图谱，并提供个性化学习路径推荐。
...
5. **在浏览器中访问系统**
   ...
   - 局域网访问：http://[您的IP地址]:328 (使用`--host`选项时)
...
- 项目GitHub仓库：https://github.com/yourusername/EduMind
