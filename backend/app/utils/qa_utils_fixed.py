...
请提供有帮助的回答。如果你不确定答案，请诚实地说明。"""
            ...
            # 发送请求到Ollama API
            response = requests.post(f"{OLLAMA_BASE_URL}/generate", json=payload, timeout=30)  # 设置30秒超时
...
{final_answer}"""
    ...
    def get_answer_stream(
        self, question: str, api_key: str, mode: str = 'video', context: str = None, use_ollama: bool = False
    ):
        """
        获取问题的答案（流式响应）
