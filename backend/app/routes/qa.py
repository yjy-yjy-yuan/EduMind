...
def ask_question():
    ...
    try:
        ...
        # 记录请求参数
        current_app.logger.info(f"请求参数: question={question_content}, mode={mode}, use_ollama={use_ollama}, deep_thinking={deep_thinking}, type={type(use_ollama)}")
        ...
        # 创建问题记录
        question = Question(
            video_id=None if mode != 'video' else video_id,
            ...
            if stream_response:
                ...
                def generate():
                    ...
                    try:
                        ...
                        for chunk in qa_system.get_answer_stream(question_content, api_key, mode, use_ollama=use_ollama, deep_thinking=deep_thinking):
                            full_answer += chunk
                            yield chunk
                ...
                # 使用非流式响应
                answer = qa_system.get_answer(question_content, api_key, mode, use_ollama=use_ollama, deep_thinking=deep_thinking)
