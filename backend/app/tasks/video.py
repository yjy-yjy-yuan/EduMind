...
def process_video_url(self, video_id, video_url):
    ...
    try:
        ...
        self.update_state(state='PROGRESS', meta={'status': '正在获取视频信息...', 'progress': 20})
                    ...
                    lambda d: (
                        self.update_state(
                            ...
                            meta={
                                'status': '正在下载视频...',
                                'progress': (
                                    20 + int(d['downloaded_bytes'] * 60 / d['total_bytes'])
        ...
        self.update_state(state='PROGRESS', meta={'status': '正在生成预览...', 'progress': 80})
        ...
        return {'status': '处理完成', 'progress': 100, 'video_id': video_id}
