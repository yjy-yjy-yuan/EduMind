...
class SimilarityService:
    ...
    def can_combine_knowledge_graphs(self, video1_tags: List[str], video2_tags: List[str], threshold: float = 0.7) -> bool:
        """
        判断两个视频的知识图谱是否可以结合
    ...
    def find_similar_videos(self, target_tags: List[str], all_videos: List[Dict[str, Any]], 
                           threshold: float = 0.6, limit: int = 5) -> List[Dict[str, Any]]:
        """
        查找与目标标签相似的视频
