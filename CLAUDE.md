...
AI-EdVision：基于深度学习的视频智能伴学系统。FastAPI + Vue 3 架构，支持视频字幕提取、知识图谱构建、AI 问答。

## Tech Stack
- **Backend**: FastAPI + SQLAlchemy 2.0 + Neo4j + Whisper + Ollama (已从 Flask 迁移)
- **Frontend**: Vue 3 + Element Plus + D3.js
- **Environment**: Python 3.10, conda env: `ai-edvision`
...
# 后端 (Terminal 1)
cd backend_fastapi && conda activate ai-edvision && python run.py
...
# 后端 (Terminal 1)
cd backend && conda activate ai-edvision && python run.py
