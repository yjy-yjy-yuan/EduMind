...
4. 推荐页“看同主题”只对站内视频开放。
5. 点击“看同主题”后，页面会立即显示加载态，并自动滚动到“相关推荐”区域。
6. “相关推荐”优先请求 `scene=related`；若接口暂无结果或失败，则会用当前页已加载的站内内容做本地同主题兜底。
7. 若当前种子视频本身来自 B 站、YouTube 或中国大学慕课，首页、上传页和推荐页的查询摘要会显示“优先来源”，帮助用户看清本轮相关推荐继承的是哪个来源平台语境。
